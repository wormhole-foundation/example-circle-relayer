...
docker build --platform=linux/amd64 -t $AWS_ACCOUNT.dkr.ecr.us-east-2.amazonaws.com/cctp-relayer:$TAG --secret id=npmrc,src=$HOME/.npmrc .
docker push $AWS_ACCOUNT.dkr.ecr.us-east-2.amazonaws.com/cctp-relayer:$TAG
